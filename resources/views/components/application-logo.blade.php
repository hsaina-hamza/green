<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {{ $attributes }}>
    ...
    <path d="M9 16L13 16" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
    <circle cx="17" cy="17" r="5" fill="#10B981"/>
    <path d="M14.5 17H19.5M17 14.5V19.5" stroke="white" stroke-width="2" stroke-linecap="round"/>
</svg>
