...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-2xl font-bold">تعديل جدول الحافلات</h2>
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                <form method="POST" action="{{ route('bus-schedules.update', $schedule) }}" class="space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div>
                        ...
                        <x-text-input id="route_number" name="route_number" type="text" class="mt-1 block w-full" 
                            value="{{ old('route_number', $schedule->route_number) }}" required placeholder="مثال: 123" />
                    ...
                    <div>
                        ...
                        <x-text-input id="route_name" name="route_name" type="text" class="mt-1 block w-full" 
                            value="{{ old('route_name', $schedule->route_name) }}" required placeholder="مثال: المحطة المركزية - الحي السكني" />
                    ...
                    <div>
                        ...
                        <div class="mt-2 space-y-2">
                            @php
                                $currentDays = old('operating_days', explode(',', $schedule->operating_days));
                            @endphp
                    ...
                    <div>
                        ...
                        <x-text-input id="frequency" name="frequency" type="number" class="mt-1 block w-full" 
                            value="{{ old('frequency', $schedule->frequency) }}" required placeholder="مثال: 30" min="1" />
                    ...
                    <div>
                        ...
                        <x-textarea id="notes" name="notes" class="mt-1 block w-full" rows="3" 
                            placeholder="أي معلومات إضافية عن الخط">{{ old('notes', $schedule->notes) }}</x-textarea>
