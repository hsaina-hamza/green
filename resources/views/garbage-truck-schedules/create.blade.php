<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Create Garbage Truck Schedule') }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('garbage-truck-schedules.store') }}" class="space-y-6">
                        @csrf
                        ...
                        <div>
                            ...
                            <x-text-input id="truck_number" name="truck_number" type="text" 
                                        class="mt-1 block w-full" :value="old('truck_number')" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="scheduled_time" name="scheduled_time" type="datetime-local" 
                                        class="mt-1 block w-full" :value="old('scheduled_time')" required />
